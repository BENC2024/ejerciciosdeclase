...
try:
    ...
    if num1 > 0 and num2 > 0:
        ...
        if es_potencia_de_dos(num1) == True:
            print("\nEl numero {} es potencia de 2".format(num1))
        elif es_potencia_de_dos(num1) == False:
            print("\nEl numero {} no es potencia de 2".format(num1))

        if es_potencia_de_dos(num2) == True:
            print("El numero {} es potencia de 2".format(num2))
        elif es_potencia_de_dos(num2) == False:
            print("El numero {} no es potencia de 2".format(num2))
